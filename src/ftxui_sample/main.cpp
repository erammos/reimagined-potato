...
// configuration step. It creates a namespace called `reimagined_potato`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", reimagined_potato::cmake::project_name, reimagined_potato::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", reimagined_potato::cmake::project_version);
      return EXIT_SUCCESS;
    }
